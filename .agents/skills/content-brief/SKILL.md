...
1. Read `AGENTS.md` and `CLAUDE.md` — get the user's content and SEO context. Do not re-ask role, channels, KPIs, approval chain, or review gates already captured there.
