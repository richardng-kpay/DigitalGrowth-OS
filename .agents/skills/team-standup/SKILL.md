...
Synthesize the weekly team standup from all members' active task files and the team board. This is a shared team ritual for any team member in a team OS, not a Growth Lead-only command.
...
- If running as the Growth Lead or explicitly asked for leadership view, add a "Team health signal" line: one sentence on the biggest risk to team OKR delivery this week
