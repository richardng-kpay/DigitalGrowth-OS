...
Reads `Tasks/active.md`, `GOALS.md`, and `Users/<active-user>/config.md` to surface:
...
3. Read `Users/<active-user>/config.md` (resolve via `Users/.active-user`) — use role, channels, and KPIs to frame the brief correctly
...
Match the tone set in `Users/<active-user>/config.md`. Default for Performance Marketer: data-first, concise, no filler.
