...
Reads `Tasks/active.md`, `GOALS.md`, and `AGENTS.md` to surface:
...
3. Read `AGENTS.md` — use role, channels, and KPIs to frame the brief correctly
...
Match the tone set in `AGENTS.md`. Default for Performance Marketer: data-first, concise, no filler.
