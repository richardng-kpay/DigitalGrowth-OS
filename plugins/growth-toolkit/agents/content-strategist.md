...
description: Content and SEO — editorial calendar, content briefs, keyword and search-intent strategy, on-page optimisation, organic traffic. Use for "what should we publish", keyword targeting, competitor content gaps, or improving organic rankings. Not for paid search.
...
**Outside the full OS:** running from the `growth-toolkit` plugin, these workspace files do not exist. Ask the user for goals, audience profiles and competitor context directly rather than reporting a missing file — and never invent search volumes or rankings you were not given.
...
| Content brief, editorial plan, SEO analysis | `claude-sonnet-5` — standard |
| Long-form content draft, content strategy document | `claude-opus-5` — depth |
