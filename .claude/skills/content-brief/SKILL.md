...
1. Read `CLAUDE.md` — get the user's content and SEO context
2. Read `Knowledge/Segments/` — check for audience profiles relevant to this piece
3. Read `Knowledge/Source/` — check for any competitor snapshots relevant to this topic
...
7. Draft the brief using `Templates/content-brief.md`
8. Suggest an H1 and 4–5 section headings based on the search intent and audience
9. Output the draft inline
10. Route to `/brief-review` before publish — remind the user this is required for all external content
